        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h1 class="font-semibold border-b-2 border-black pb-3 text-xl my-5">Mes projets</h1>
                        ...
                        <tr class="border">
                            ...
                            <td class="p-3">
                                <button class="bg-blue-500 text-white px-4 py-2 rounded">
                                    <a href="{{ route('developpeur.project.show', $project->id) }}"><i class="fa-regular fa-eye"></i></a>
                                </button>
                            </td>
                        </tr>
                        @endforeach
